...
preferences {
       input "ohmidCode", "text", title: "Ohm Id", 
...
metadata {
    ...
    tiles(scale: 2) {
        ...
        valueTile("ohmID", "device.ohmidCode", decoration: "flat", wordWrap: false, width: 4, height: 2) {
        	state "default", label:'${settings.ohmidCode}', unit:"", backgroundColor:"#ffffff"
    	}
